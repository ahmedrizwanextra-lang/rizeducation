      ...
      <section className="px-6 py-16 md:py-20 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            We've refined our approach over years of helping students. Here's exactly how we'll guide you from start to finish.
          </p>
        </div>
      </section>
          ...
          <div className="relative mt-16 grid gap-10 md:grid-cols-5">
            ...
            {processSteps.map((s) => (
              <div key={s.n} className="relative flex flex-col items-center">
                <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-[#1a2744] text-sm font-bold text-white shadow-lg">
                  {s.n}
                </div>
                <div className="mt-6 flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 shadow-md">
                  <i className={`fas fa-${s.icon} text-3xl text-[#1a2744]`}></i>
                </div>
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1a2744] text-lg font-bold text-white">
                      {step.n}
                    </div>
                  ...
                  <ul className="mt-4 space-y-2 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
                      <i className="fas fa-check text-[#f0b429]"></i> Personalized attention
                    </li>
                    <li className="flex items-center gap-2">
                      <i className="fas fa-check text-[#f0b429]"></i> Expert guidance
                    </li>
                    <li className="flex items-center gap-2">
                      <i className="fas fa-check text-[#f0b429]"></i> Regular updates
                    </li>
                  </ul>
                </div>
                <div className="flex-1">
                  <div className="flex h-48 items-center justify-center rounded-2xl bg-white p-8 shadow-lg">
                    <i className={`fas fa-${step.icon} text-6xl text-[#f0b429]/30`}></i>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="max-w-md text-gray-300">
                Book a free consultation and let's map out your path to success.
              </p>
            </div>
          </div>
          <a
